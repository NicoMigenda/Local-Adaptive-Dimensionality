...
load Dim_32_Cluster_5_Length_50000_Threshold_70_Overlap.mat
for i=1:5
...
load Dim_32_Cluster_5_Length_50000_Threshold_90_Overlap.mat
for i=1:5
    data90{i}.data = squeeze(dim(i,:,:));
    data90{i}.data(data90{i}.data(:,end) == 2,:) = [];
end
load Dim_32_Cluster_5_Length_50000_Threshold_95_Overlap.mat
for i=1:5
