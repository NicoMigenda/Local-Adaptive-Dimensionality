...
figure
scatter(1:100000,squeeze(mean(dim(1,:,:))),3,'filled')
hold on
scatter(1:100000,squeeze(mean(dim(2,:,:))),3,'filled')
scatter(1:100000,squeeze(mean(dim(3,:,:))),3,'filled')
scatter(1:100000,squeeze(mean(dim(4,:,:))),3,'filled')
scatter(1:100000,squeeze(mean(dim(5,:,:))),3,'filled')
%ylim([1.9 3.1])
...
export_fig  Adaptionsverlauf -transparent -pdf
